      ...
      <div className="p-5 flex flex-col items-center">
        ...
        <form className="inputs px-10 pb-10">
          <input
            ...
            className="w-full rounded-lg shadow-black mb-3 pl-2 h-10 text-xl shadow-sm"
          />
          <input
            type="password"
          ...
          <button
            type="submit"
            className="w-full bg-black text-white text-2xl py-1 h-10 rounded-lg shadow-sm mt-10"
          >
            Log In
          </button>
        </form>
